    ...
    public void OverlayButtonClicking() {
		if (IsTextFilled == true) {
			if (PrologueNumber == 1) {
				IsTextFilled = false;
				PrologueNumber = 2;
				PrologueString = "All of us have fled, and some have started to become influenced by the evil of Hades. I have asked Hermes to find you and start a new island chain: Mount " + MainCharacterInformation.HomeNameChoice + ".";
